...
public class PropertyCell extends Cell {
	...
	public int getRent() {
		...
		rentToCharge = calculatedMonopoliesRent(rentToCharge, monopolies);
		if(numHouses > 0) {
	...
	/**
	 * Calculated monopolies rent.
	 *
	 * @param rentToCharge the rent to charge
	 * @param monopolies the monopolies
	 * @return the int
	 */
	private int calculatedMonopoliesRent(int rentToCharge, String[] monopolies) {
